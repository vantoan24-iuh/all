...
<head>
    ...
    <link rel="stylesheet" href="resource/css/productlist.css">
...
<div class="container">
    ...
    <hr>
    <h1 class="text-center mt-2">Function Employee</h1>
    <div class="row justify-content-center">
        <div class="col-1">
            <a href="controller?action=add" class="btn btn-outline-primary">Insert</a>
        </div>
        <div class="col-1">
            <a href="controller?action=edit" class="btn btn-outline-primary">Update</a>
        </div>
        <div class="col-1">
            <a href="controller?action=delete" class="btn btn-outline-primary">Delete</a>
        </div>
    </div>
